        ...
        <div class="h-screen justify-center items-center flex flex-col flex-1  m-auto ">
            <div class="w-[550px]">
                ...
                <p>Нужно как можно быстрее определить, в какой части экрана (правой или левой) 
                    от центра расположен этот квадрат, нажав клавишу Q (слева) или P (справа)</p>
                <p>[Нажимте любую клавишу для старта]</p>
            </div>
        </div>
    </div>
...
document.addEventListener("keyup", start_game);
