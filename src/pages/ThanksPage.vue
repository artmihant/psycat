...
<div class="h-screen justify-center">    
    <div class="h-screen w-full justify-center 
        ...
        <div class="max-w-[550px]"> 
            ...
            <p>Если вас интересуют результаты нашего исследования, <br />можете указать email для обратной связи:</p>
            <input class="border-0 border-b" type="text" v-model="email" name="email" placeholder="Email для обратной связи" >
        </div>
        <div class="mt-6 text-center font-bold">
            <div @click="save" class=" cursor-pointer rounded-lg border px-2 py-3 inline border-neutral-700 bg-white text-neutral-900 hover:bg-neutral-100">
                Сохранить
            </div>
        </div>
